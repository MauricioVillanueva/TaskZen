  ...
  return (
    <div className="flex h-[1080px] w-full relative items-center justify-center antialiased overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center w-full">
        <div
          style={{ boxShadow: "inset 0px 0px 80px 80px #1E293B" }}
...
export const SVGs: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <filter id="neonGlow" x="-10%" y="-50%" width="120%" height="200%">
      ...
      {/* CIRCLES */}
      <circle cx="468" cy="326" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="275" cy="331" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="89" cy="431" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="27" cy="466" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="194" cy="485" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="161" cy="514" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="14" cy="535" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="94" cy="598" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="536" cy="503" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="338" cy="480" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="325" cy="626" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="435" cy="664" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="525" cy="631" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="421" cy="552" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="535" cy="573" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="460" cy="741" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="322" cy="751" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="17" cy="728" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="66" cy="719" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="176" cy="655" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="154" cy="677" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="530" cy="756" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="676" cy="936" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="881" cy="1066" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="976" cy="984" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1077" cy="1067" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1122" cy="970" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1224" cy="944" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1079" cy="879" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1008" cy="870" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="910" cy="868" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1238" cy="862" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1384" cy="578" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1385" cy="508" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1395" cy="451" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1389" cy="325" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1460" cy="340" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1598" cy="330" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1903" cy="353" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1854" cy="362" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1766" cy="404" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1745" cy="426" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1827" cy="483" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1485" cy="418" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1596" cy="455" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1583" cy="601" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1500" cy="528" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1759" cy="567" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1726" cy="597" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1907" cy="546" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1893" cy="615" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1830" cy="650" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1646" cy="750" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1452" cy="755" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1239" cy="144" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1005" cy="212" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="837" cy="201" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="910" cy="211" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="678" cy="218" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="692" cy="138" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="794" cy="111" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="842" cy="12" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="940" cy="96" r="5" stroke="#4FC1FF" stroke-width="2" />
      <circle cx="1035" cy="13" r="5" stroke="#4FC1FF" stroke-width="2" />
    </svg>
  );
};
